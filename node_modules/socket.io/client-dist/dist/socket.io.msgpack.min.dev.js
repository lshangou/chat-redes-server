...
!function (t, e) {
  ...
  return function (t) {
    ...
    u.prototype.encode = function (t) {
      ...
      if (!(s(t.type) && t.type >= i.CONNECT && t.type <= i.CONNECT_ERROR)) throw new Error("invalid packet type");
      if (!c(t.nsp)) throw new Error("invalid namespace");
      if (!function (t) {
        switch (t.type) {
          case i.CONNECT:
            return void 0 === t.data || a(t.data);

          case i.DISCONNECT:
            return void 0 === t.data;

          case i.CONNECT_ERROR:
            return c(t.data) || a(t.data);
    ...
    }, f.prototype.destroy = function () {}, e.Encoder = u, e.Decoder = f;
  }, function (t, e) {
      ...
      return e = u, (n = [{
        ...
        value: function value() {
          var t = this.query || {},
              ...
              n = "";
          return !1 !== this.opts.timestampRequests && (t[this.opts.timestampParam] = l()), this.supportsBinary || t.sid || (t.b64 = 1), t = h.encode(t), this.opts.port && ("https" === e && 443 !== Number(this.opts.port) || "http" === e && 80 !== Number(this.opts.port)) && (n = ":" + this.opts.port), t.length && (t = "?" + t), e + "://" + (-1 !== this.opts.hostname.indexOf(":") ? "[" + this.opts.hostname + "]" : this.opts.hostname) + n + this.opts.path + t;
        }
      }, {
        key: "name",
        get: function get() {
    ...
    var p = n(5),
      ...
      return e = f, (n = [{
        ...
        value: function value() {
          if (!this.subs) {
            var t = this.io;
            this.subs = [l.on(t, "open", this.onopen.bind(this)), l.on(t, "packet", this.onpacket.bind(this)), l.on(t, "error", this.onerror.bind(this)), l.on(t, "close", this.onclose.bind(this))];
          }
        }
      }, {
        key: "connect",
        ...
        value: function value(t) {
          ...
          c(h(f.prototype), "emit", this).apply(this, t);
        }
      }, {
        key: "ack",
        value: function value(t) {
    ...
    var h = function (t) {
      ...
      return e = h, (n = [{
        key: "on",
        value: function value(t, e) {
          return s(f(h.prototype), "on", this).call(this, t, e), this;
        }
      }, {
        key: "once",
        value: function value(t, e) {
          return s(f(h.prototype), "once", this).call(this, t, e), this;
        }
      }, {
        key: "emit",
        value: function value(t) {
          ...
          return (e = s(f(h.prototype), "emit", this)).call.apply(e, [this, t].concat(r)), this;
        }
      }, {
        key: "emitReserved",
        value: function value(t) {
        ...
        key: "listeners",
        value: function value(t) {
          return s(f(h.prototype), "listeners", this).call(this, t);
        }
      }]) && i(e.prototype, n), r && i(e, r), h;
    }(n(1));

    e.StrictEventEmitter = h;
  }, function (t, e, n) {
    "use strict";
    ...
    function c(t, e) {
      ...
      var n,
          ...
          f = c.path,
          h = s[u] && f in s[u].nsps;
      return e.forceNew || e["force new connection"] || !1 === e.multiplex || h ? n = new i.Manager(a, e) : (s[u] || (s[u] = new i.Manager(a, e)), n = s[u]), c.query && !e.query && (e.query = c.queryKey), n.socket(c.path, e);
    }
    ...
    var h = n(8),
      ...
      return e = p, (n = [{
        ...
        key: "onOpen",
        value: function value() {
          if (this.readyState = "open", p.priorWebsocketSuccess = "websocket" === this.transport.name, this.emit("open"), this.flush(), "open" === this.readyState && this.opts.upgrade && this.transport.pause) for (var t = 0, e = this.upgrades.length; t < e; t++) {
    ...
    v.priorWebsocketSuccess = !1, v.protocol = l.protocol, t.exports = v;
  }, function (t, e) {
    try {
    ...
    var g = null != new l({
      ...
      return c(n, [{
        ...
        value: function value() {
          ...
          var r = this.xhr = new l(e);

          try {
            r.open(this.method, this.uri, this.async);

            try {
              if (this.opts.extraHeaders) for (var o in r.setDisableHeaderCheck && r.setDisableHeaderCheck(!0), this.opts.extraHeaders) {
    ...
    if (w.requestsCount = 0, w.requests = {}, "undefined" != typeof document) if ("function" == typeof attachEvent) attachEvent("onunload", k);else if ("function" == typeof addEventListener) {
      addEventListener("onpagehide" in b ? "pagehide" : "unload", k, !1);
    }
    ...
    t.exports = _, t.exports.Request = w;
  }, function (t, e, n) {
    ...
    !function (t) {
      ...
      e.encode = function (e) {
        ...
        for (n = 0; n < a; n += 4) {
          r = t.indexOf(e[n]), o = t.indexOf(e[n + 1]), i = t.indexOf(e[n + 2]), s = t.indexOf(e[n + 3]), h[u++] = r << 2 | o >> 4, h[u++] = (15 & o) << 4 | i >> 2, h[u++] = (3 & i) << 6 | 63 & s;
        }
    ...
    var h,
      ...
      function p(t) {
        ...
        return function (t, e) {
          if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function");
        }(this, p), (e = a.call(this, t)).query = e.query || {}, h || (h = l.___eio = l.___eio || []), e.index = h.length, h.push(e.onData.bind(u(e))), e.query.j = e.index, e;
      }

      return e = p, (n = [{
        key: "doClose",
        value: function value() {
          this.script && (this.script.onerror = function () {}, this.script.parentNode.removeChild(this.script), this.script = null), this.form && (this.form.parentNode.removeChild(this.form), this.form = null, this.iframe = null), i(f(p.prototype), "doClose", this).call(this);
        }
      }, {
        key: "doPoll",
        value: function value() {
      ...
      return e = a, (n = [{
        ...
        value: function value() {
          if (this.check()) {
            var t = this.uri(),
                ...
                n = m ? {} : l(this.opts, "agent", "perMessageDeflate", "pfx", "key", "passphrase", "cert", "ca", "ciphers", "rejectUnauthorized", "localAddress", "protocolVersion", "origin", "maxPayload", "family", "checkServerIdentity");
        ...
        value: function value() {
          var t = this.query || {},
              ...
              n = "";
          return this.opts.port && ("wss" === e && 443 !== Number(this.opts.port) || "ws" === e && 80 !== Number(this.opts.port)) && (n = ":" + this.opts.port), this.opts.timestampRequests && (t[this.opts.timestampParam] = p()), this.supportsBinary || (t.b64 = 1), (t = h.encode(t)).length && (t = "?" + t), e + "://" + (-1 !== this.opts.hostname.indexOf(":") ? "[" + this.opts.hostname + "]" : this.opts.hostname) + n + this.opts.path + t;
        }
      }, {
        key: "check",
        value: function value() {
    ...
    function o(t, e, n) {
      for (var r = 0, o = 0, i = n.length; o < i; o++) {
        (r = n.charCodeAt(o)) < 128 ? t.setUint8(e++, r) : r < 2048 ? (t.setUint8(e++, 192 | r >> 6), t.setUint8(e++, 128 | 63 & r)) : r < 55296 || r >= 57344 ? (t.setUint8(e++, 224 | r >> 12), t.setUint8(e++, 128 | r >> 6 & 63), t.setUint8(e++, 128 | 63 & r)) : (o++, r = 65536 + ((1023 & r) << 10 | 1023 & n.charCodeAt(o)), t.setUint8(e++, 240 | r >> 18), t.setUint8(e++, 128 | r >> 12 & 63), t.setUint8(e++, 128 | r >> 6 & 63), t.setUint8(e++, 128 | 63 & r));
      }
    }
    ...
    t.exports = function (t) {
      var e = [],
        ...
        if ("string" === i) {
          if ((f = function (t) {
            ...
            return n;
          }(o)) < 32) e.push(160 | f), h = 1;else if (f < 256) e.push(217, f), h = 2;else if (f < 65536) e.push(218, f >> 8, f), h = 3;else {
            if (!(f < 4294967296)) throw new Error("String too long");
            e.push(219, f >> 24, f >> 16, f >> 8, f), h = 5;
          }
          return n.push({
            _str: o,
            _length: f,
        ...
        if ("number" === i) return Math.floor(o) === o && isFinite(o) ? o >= 0 ? o < 128 ? (e.push(o), 1) : o < 256 ? (e.push(204, o), 2) : o < 65536 ? (e.push(205, o >> 8, o), 3) : o < 4294967296 ? (e.push(206, o >> 24, o >> 16, o >> 8, o), 5) : (a = o / Math.pow(2, 32) >> 0, u = o >>> 0, e.push(207, a >> 24, a >> 16, a >> 8, a, u >> 24, u >> 16, u >> 8, u), 9) : o >= -32 ? (e.push(o), 1) : o >= -128 ? (e.push(208, o), 2) : o >= -32768 ? (e.push(209, o >> 8, o), 3) : o >= -2147483648 ? (e.push(210, o >> 24, o >> 16, o >> 8, o), 5) : (a = Math.floor(o / Math.pow(2, 32)), u = o >>> 0, e.push(211, a >> 24, a >> 16, a >> 8, a, u >> 24, u >> 16, u >> 8, u), 9) : (e.push(203), n.push({
          _float: o,
          _length: 8,
          _offset: e.length
        }), 9);
        ...
        if ("object" === i) {
          if (null === o) return e.push(192), 1;

          if (Array.isArray(o)) {
            if ((f = o.length) < 16) e.push(144 | f), h = 1;else if (f < 65536) e.push(220, f >> 8, f), h = 3;else {
              if (!(f < 4294967296)) throw new Error("Array too large");
              e.push(221, f >> 24, f >> 16, f >> 8, f), h = 5;
            }
          ...
          if (o instanceof Date) {
            var p = o.getTime();
            return a = Math.floor(p / Math.pow(2, 32)), u = p >>> 0, e.push(215, 0, a >> 24, a >> 16, a >> 8, a, u >> 24, u >> 16, u >> 8, u), 10;
          }

          if (o instanceof ArrayBuffer) {
            if ((f = o.byteLength) < 256) e.push(196, f), h = 2;else if (f < 65536) e.push(197, f >> 8, f), h = 3;else {
              if (!(f < 4294967296)) throw new Error("Buffer too large");
              e.push(198, f >> 24, f >> 16, f >> 8, f), h = 5;
            }
            return n.push({
              _bin: o,
              _length: f,
          ...
          if ("function" == typeof o.toJSON) return t(e, n, o.toJSON());
          var l = [],
              y = "",
              d = Object.keys(o);

          for (s = 0, c = d.length; s < c; s++) {
            "function" != typeof o[y = d[s]] && l.push(y);
          }

          if ((f = l.length) < 16) e.push(128 | f), h = 1;else if (f < 65536) e.push(222, f >> 8, f), h = 3;else {
            if (!(f < 4294967296)) throw new Error("Object too large");
            e.push(223, f >> 24, f >> 16, f >> 8, f), h = 5;
          }

          for (s = 0; s < f; s++) {
            h += t(e, n, y = l[s]), h += t(e, n, o[y]);
          }

          return h;
        }

        if ("boolean" === i) return e.push(o ? 195 : 194), 1;
        if ("undefined" === i) return e.push(212, 0, 0), 3;
      ...
      n.length > 0 && (f = n[0]._offset);

      for (var h, p = 0, l = 0, y = 0, d = e.length; y < d; y++) {
        if (c.setUint8(u + y, e[y]), y + 1 === f) {
          if (p = (h = n[a])._length, l = u + f, h._bin) for (var v = new Uint8Array(h._bin), b = 0; b < p; b++) {
            c.setUint8(l + b, v[b]);
          } else h._str ? o(c, l, h._str) : void 0 !== h._float && c.setFloat64(l, h._float);
          u += p, n[++a] && (f = n[a]._offset);
        }
      }
    ...
    function r(t) {
      if (this._offset = 0, t instanceof ArrayBuffer) this._buffer = t, this._view = new DataView(this._buffer);else {
    ...
    r.prototype._array = function (t) {
      for (var e = new Array(t), n = 0; n < t; n++) {
        e[n] = this._parse();
      }

      return e;
    }, r.prototype._map = function (t) {
      for (var e = {}, n = 0; n < t; n++) {
        e[this._parse()] = this._parse();
      }

      return e;
    }, r.prototype._str = function (t) {
      var e = function (t, e, n) {
        for (var r = "", o = 0, i = e, s = e + n; i < s; i++) {
          ...
          if (0 != (128 & c)) {
            if (192 != (224 & c)) {
              if (224 != (240 & c)) {
                if (240 != (248 & c)) throw new Error("Invalid byte " + c.toString(16));
                (o = (7 & c) << 18 | (63 & t.getUint8(++i)) << 12 | (63 & t.getUint8(++i)) << 6 | (63 & t.getUint8(++i)) << 0) >= 65536 ? (o -= 65536, r += String.fromCharCode(55296 + (o >>> 10), 56320 + (1023 & o))) : r += String.fromCharCode(o);
              } else r += String.fromCharCode((15 & c) << 12 | (63 & t.getUint8(++i)) << 6 | (63 & t.getUint8(++i)) << 0);
            } else r += String.fromCharCode((31 & c) << 6 | 63 & t.getUint8(++i));
